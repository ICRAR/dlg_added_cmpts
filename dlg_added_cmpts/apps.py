"""
dlg_added_cmpts appComponent module.

This is the module of dlg_added_cmpts containing DALiuGE application components.
...
# @param[in] param/appclass Application Class/dlg_added_cmpts.MyApp/String/readonly/
