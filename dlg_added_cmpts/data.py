"""
dlg_added_cmpts component module.

This is the module of dlg_added_cmpts containing DALiuGE data components.
...
# Pythonpath to import MyDataDROP.
#
# @par EAGLE_START
# @param category DataDrop
# @param[in] param/appclass Drop Class/dlg_added_cmpts.MyData/String/readonly/
